...
data class HospitalModel(
	...
	@Column(columnDefinition = "nvarchar(255)")
	var nursingHomeNumber: String? = null,
	@Column(columnDefinition = "nvarchar(255)")
	...
	var userHospitalRelations: MutableList<UserPharmaceuticalHospital>? = null
	) {
	fun findHeader(data: List<String>): Boolean {
		if (data.size < FConstants.HOS_MODEL_COUNT) {
			return false
		}
	...
	fun errorString(): String {
		...
		for (i in 0 until FConstants.HOS_MODEL_COUNT) {
