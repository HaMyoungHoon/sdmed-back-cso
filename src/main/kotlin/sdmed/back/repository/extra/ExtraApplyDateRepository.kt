...
interface ExtraApplyDateRepository: JpaRepository<EDIApplyDateModel, String> {
    @Query("SELECT new sdmed.back.model.sqlCSO.extra.ExtraEDIDueDateResponse(a.year, a.month)" +
            "FROM EDIApplyDateModel a " +
            "WHERE a.applyDateState = :applyDateState " +
            "ORDER BY a.year DESC, a.month DESC")
    fun selectAllByUse(applyDateState: EDIApplyDateState = EDIApplyDateState.Use): List<ExtraEDIDueDateResponse>
